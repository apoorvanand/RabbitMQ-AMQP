...
public final class MQDisconnectAction implements Action{
	private static final String BUNDLE_NAME = "com.RMQ.MQActions.bundledisconnect";
...
static enum RMQParameter {
	...
	public Class<? extends ActionEngine> getEngineClass() {
		return MQDisconnectActionEngine.class;
	}
	...
	public String getDescription() {
		...
		description.append("MDisConnect description.\n");
