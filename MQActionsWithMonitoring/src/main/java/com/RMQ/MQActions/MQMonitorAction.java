...
import com.RMQ.MQActions.MQConnectAction.RMQParameter;
import com.google.common.base.Optional;
import com.neotys.extensions.action.Action;
import com.neotys.extensions.action.ActionParameter;
import com.neotys.extensions.action.engine.ActionEngine;

public final class MQMonitorAction implements Action{
	private static final String BUNDLE_NAME = "com.RMQ.MQActions.bundlemonitor";
...
static enum RMQParameter {
	...
	public Class<? extends ActionEngine> getEngineClass() {
		return MQMonitorActionEngine.class;
	}
	...
	public String getDescription() {
		...
		description.append("MQMonitor description.\n");
